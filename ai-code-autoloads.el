...

;;; Generated autoloads from ai-code-antigravity-cli.el

(defvar ai-code-antigravity-cli-program "agy" "\
Path to the Antigravity CLI executable.")
(custom-autoload 'ai-code-antigravity-cli-program "ai-code-antigravity-cli" t)
(defvar ai-code-antigravity-cli-program-switches nil "\
Command line switches to pass to Antigravity CLI on startup.")
(custom-autoload 'ai-code-antigravity-cli-program-switches "ai-code-antigravity-cli" t)
(autoload 'ai-code-antigravity-cli "ai-code-antigravity-cli" "\
...
(fn &optional ARG)" t)
(autoload 'ai-code-antigravity-cli-switch-to-buffer "ai-code-antigravity-cli" "\
Switch to the Antigravity CLI buffer.
When FORCE-PROMPT is non-nil, prompt to select a session.

(fn &optional FORCE-PROMPT)" t)
(autoload 'ai-code-antigravity-cli-send-command "ai-code-antigravity-cli" "\
Send LINE to Antigravity CLI.

(fn LINE)" t)
(autoload 'ai-code-antigravity-cli-send-escape "ai-code-antigravity-cli" "\
Send escape key to Antigravity CLI." t)
(autoload 'ai-code-antigravity-cli-resume "ai-code-antigravity-cli" "\
Resume a previous Antigravity CLI session.
Argument ARG is passed to the start command.

(fn &optional ARG)" t)
(register-definition-prefixes "ai-code-antigravity-cli" '("ai-code-antigravity-cli-"))
