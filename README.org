...
**** Open Interpreter CLI setup
     [[https://github.com/openinterpreter/openinterpreter][Open Interpreter CLI]] is treated as a Codex-compatible CLI. Ensure the `open-interpreter` executable is on your PATH.
     ...
     #+end_src
     Resume appends =resume= the same way as Codex.
...
*** Q: [[https://github.com/tninja/ai-code-interface.el/issues/398][Unable to Esc to go back after invoking the slash commands in claude-code shell?]]
